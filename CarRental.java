...
public class CarRental extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (objSource == btnCalculate) {
            try {
                ...
                totalCost = calculateTotal(beginning, ending, numOfDays);
                ...
                txaOutput.setText("-- CUSTOMER INFO. --" + "\n" +
                                  ...
                                  "Average Spent By Customers: " + fmtCurrency.format(totalAmountCollected/totalCars));
    ...
    public double calculateTotal(double beg, double end, int days) {
        double cost = 0;
        cost += days * 15 + (end - beg) * 0.12;
        return cost;
    }
